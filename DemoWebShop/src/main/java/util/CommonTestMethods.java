...
public class CommonTestMethods {
	...
	public String capture_ss(String f1, String sdir) throws IOException { 
		...
		Files.copy(sr, new File(sdir+"/"+f1+System.currentTimeMillis()+".png")); //Filepath
		
		String destination = sdir+"/"+f1+System.currentTimeMillis()+".png";
